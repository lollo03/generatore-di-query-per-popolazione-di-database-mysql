from tipi import nome, cognome, intero, data, dataora, sequenzaInteri, sequenzaStringhe, randomStringhe,generaQuery

#MODIFICA QUA SOTTO
struttura = [nome(), cognome(), intero(70, 18), data(1990, 2002), dataora(2020), sequenzaInteri(5, 1), sequenzaStringhe(["questo", "è", "un", "test"]), randomStringhe(["questo", "è", "un", "test"])]
iterazioni = 3
tabella = "persone"
